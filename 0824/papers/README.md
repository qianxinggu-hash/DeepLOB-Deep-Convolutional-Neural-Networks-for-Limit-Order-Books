...
| CST | Cont, Stoikov and Talreja (2010), _A Stochastic Model for Order Book Dynamics_[^3] | [PDF](Cont_Stoikov_Talreja_2010_A_Stochastic_Model_for_Order_Book_Dynamics.pdf) | L2 新增、撤单和主动成交速率；[对当前 GP 的适用性评估](../../0913/CST2010_适用性评估.md) |
...
[^3]: Cont, R., Stoikov, S., and Talreja, R. (2010). "A Stochastic Model for Order Book Dynamics." _Operations Research_, 58(3), 549–563. https://doi.org/10.1287/opre.1090.0780 . 作者公开 PDF：http://rama.cont.perso.math.cnrs.fr/pdf/CST2010.pdf 。下载与文件校验记录见适用性评估。
