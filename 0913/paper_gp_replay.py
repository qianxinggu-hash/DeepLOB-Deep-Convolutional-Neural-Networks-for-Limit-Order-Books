...
def simulate_gp_day(
    ...
    """Replay original GP cashflows, adding time-weighted inventory diagnostics."""
    ...
    def transact_market(target_inventory: int, best_bid: float, best_ask: float, event_time_ms: int) -> None:
