...
for directory in ("0920", "0906", "0824"):
...
class InventoryExposureTests(unittest.TestCase):
    def test_time_integral_includes_flat_long_short_and_gap(self):
        ...
        self.assertEqual(m["negative_inventory_time_seconds"], 3.0)
        self.assertEqual(m["positive_inventory_time_seconds"], 3.0)
        self.assertEqual(m["short_inventory_lot_seconds"], 3.0)
        self.assertEqual(m["long_inventory_lot_seconds"], 6.0)
        self.assertAlmostEqual(m["negative_inventory_time_share"], 0.3)
        self.assertAlmostEqual(m["positive_inventory_time_share"], 0.3)
